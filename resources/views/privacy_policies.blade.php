...
@section('template_body')
    ...
    <section id="body-content">
        <div class="inner">
            ...
            <p>La presente Política de Privacidad establece los términos en que <strong>Gabu App</strong> usa y protege la información que es proporcionada por sus usuarios al momento de utilizar su sitio web. Esta compañía está comprometida con la seguridad de los datos de sus usuarios. Cuando le pedimos llenar los campos de información personal con la cual usted pueda ser identificado, lo hacemos asegurando que sólo se empleará de acuerdo con los términos de este documento. Sin embargo esta Política de Privacidad puede cambiar con el tiempo o ser actualizada por lo que le recomendamos y enfatizamos revisar continuamente esta página para asegurarse que está de acuerdo con dichos cambios.</p>
            ...
            <p><strong>Gabu App</strong> no almacena en sus servidores o en su dispositivo móvil celular los datos de su <strong>tarjeta de crédito</strong>. Por ende, en cada compra realizada debe introducir, nuevamente, los datos de su tarjeta de crédito.</p>
            ...
            <p><strong>Gabu App</strong> se reserva el derecho de cambiar los términos de la presente Política de Privacidad en cualquier momento.</p>
