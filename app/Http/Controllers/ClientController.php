...
class ClientController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($token = $this->guard()->attempt($credentials)) {
            return response()->json(['status' => 'success', 'token' => 'null'], 200)->header('Authorization', $token);
        }
